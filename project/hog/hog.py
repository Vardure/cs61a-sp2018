...
def free_bacon(score):
    ...
    if score < 10:
        return score + 2
    elif score >= 10 & score <= 99:
        one_digit = score % 10
        ten_digit = score // 10
        return abs(ten_digit - one_digit) + 2
    # END PROBLEM 2
...
def is_swap(score0, score1):
    ...
    if (score0 <= 1) | (score1 <= 1):
        return False
    elif (score0 > 1) & (score1 > 1):
        if (score1 % score0 != 0) & (score0 % score1 !=0):
            return False
        else:
            return True
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    "*** YOUR CODE HERE ***"
    def say(score0, score1):
        #We want to change the values of the both arguments, thus we use nonlocal to modify the variables
        #Because we won't change the value of "who", thus we don't modify it either
